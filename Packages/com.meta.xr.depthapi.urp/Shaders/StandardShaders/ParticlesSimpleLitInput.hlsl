...
half4 SampleSpecularSmoothness(float2 uv, float3 blendUv, half alpha, half4 specColor, META_DEPTH_TEX2D_PARAM(specGlossMap, sampler_specGlossMap))
{
    half4 specularGloss = half4(0, 0, 0, 1);
#ifdef _SPECGLOSSMAP
    specularGloss = BlendTexture(META_DEPTH_TEX2D_ARGS(specGlossMap, sampler_specGlossMap), uv, blendUv);
