...
* **Meta XR Core SDK (v60.0.0 or above)** by using one of the following methods:
  ...
  * Import the **com.meta.xr.sdk.core (v60.0.0 or above)** package from Unity's package manager. Follow the instructions on importing individual SDKs in Unity outlined [in the official Oculus documentation](https://developer.oculus.com/documentation/unity/unity-package-manager/).
